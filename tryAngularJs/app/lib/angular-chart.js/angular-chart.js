(function (factory) {
  ...
  function ChartJsFactory(ChartJs, $timeout) {
    ...
    function getEventHandler(scope, action, triggerOnlyOnChange) {
      ...
      return function (evt) {
        var atEvent =
          scope.chart.getElementAtEvent || scope.chart.getPointAtEvent;
        var atEvents =
          scope.chart.getElementsAtEvent || scope.chart.getPointsAtEvent;
        if (atEvents) {
          ...
          if (
            ...
            (!angular.equals(lastState.points, points) &&
              !angular.equals(lastState.point, point))
          ) {
