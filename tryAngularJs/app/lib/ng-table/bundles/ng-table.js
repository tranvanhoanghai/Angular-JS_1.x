(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["ng-table"] = factory(root["angular"]);
  ...
  \***************************/
      /***/ function (module, exports, __webpack_require__) {
        ...
        var ngTableSettings_1 = __webpack_require__(
          /*! ./ngTableSettings */ 10
        );
        var ngTableParams_1 = __webpack_require__(/*! ./ngTableParams */ 9);
        var ngTableEventsChannel_1 = __webpack_require__(
          /*! ./ngTableEventsChannel */ 8
        );
        var ngTableCoreModule = angular
          .module("ngTable-core", [])
          .provider(
            "ngTableDefaultGetData",
            data_1.NgTableDefaultGetDataProvider
          )
          .factory(
            "ngTableDefaultGetGroups",
            grouping_1.ngTableDefaultGetGroups
          )
          .value("ngTableDefaults", ngTableDefaults_1.ngTableDefaults)
          .service(
            "ngTableEventsChannel",
            ngTableEventsChannel_1.NgTableEventsChannel
          )
        ...
        var ngTableSettings_2 = __webpack_require__(
          /*! ./ngTableSettings */ 10
        );
  ...
  \******************************/
      /***/ function (module, exports, __webpack_require__) {
        ...
        var angular = __webpack_require__(/*! angular */ 0);
        var ngTable_directive_1 = __webpack_require__(
          /*! ./ngTable.directive */ 13
        );
        var ngTableColumn_1 = __webpack_require__(/*! ./ngTableColumn */ 14);
        var ngTableColumnsBinding_directive_1 = __webpack_require__(
          /*! ./ngTableColumnsBinding.directive */ 15
        );
        var ngTableController_1 = __webpack_require__(
          /*! ./ngTableController */ 16
        );
        exports.NgTableController = ngTableController_1.NgTableController;
        var ngTableDynamic_directive_1 = __webpack_require__(
          /*! ./ngTableDynamic.directive */ 17
        );
        var ngTableFilterConfig_1 = __webpack_require__(
          /*! ./ngTableFilterConfig */ 18
        );
        exports.NgTableFilterConfigProvider =
          ngTableFilterConfig_1.NgTableFilterConfigProvider;
        exports.NgTableFilterConfig = ngTableFilterConfig_1.NgTableFilterConfig;
        var ngTableFilterRow_directive_1 = __webpack_require__(
          /*! ./ngTableFilterRow.directive */ 19
        );
        var ngTableFilterRowController_1 = __webpack_require__(
          /*! ./ngTableFilterRowController */ 20
        );
        var ngTableGroupRow_directive_1 = __webpack_require__(
          /*! ./ngTableGroupRow.directive */ 21
        );
        var ngTableGroupRowController_1 = __webpack_require__(
          /*! ./ngTableGroupRowController */ 22
        );
        var ngTablePagination_directive_1 = __webpack_require__(
          /*! ./ngTablePagination.directive */ 23
        );
        var ngTableSelectFilterDs_directive_1 = __webpack_require__(
          /*! ./ngTableSelectFilterDs.directive */ 24
        );
        var ngTableSorterRow_directive_1 = __webpack_require__(
          /*! ./ngTableSorterRow.directive */ 25
        );
        var ngTableSorterRowController_1 = __webpack_require__(
          /*! ./ngTableSorterRowController */ 26
        );
        ...
        var ngTableBrowserModule = angular
          .module("ngTable-browser", [])
          .directive("ngTable", ngTable_directive_1.ngTable)
          .service("ngTableColumn", ngTableColumn_1.NgTableColumn)
          .directive(
            "ngTableColumnsBinding",
            ngTableColumnsBinding_directive_1.ngTableColumnsBinding
          )
          .controller(
            "ngTableController",
            ngTableController_1.NgTableController
          )
          .directive(
            "ngTableDynamic",
            ngTableDynamic_directive_1.ngTableDynamic
          )
          .provider(
            "ngTableFilterConfig",
            ngTableFilterConfig_1.NgTableFilterConfigProvider
          ...
          .directive(
            "ngTableFilterRow",
            ngTableFilterRow_directive_1.ngTableFilterRow
          )
          .controller(
            "ngTableFilterRowController",
            ngTableFilterRowController_1.NgTableFilterRowController
          )
          .directive(
            "ngTableGroupRow",
            ngTableGroupRow_directive_1.ngTableGroupRow
          )
          .controller(
            "ngTableGroupRowController",
            ngTableGroupRowController_1.NgTableGroupRowController
          )
          .directive(
            "ngTablePagination",
            ngTablePagination_directive_1.ngTablePagination
          )
          .directive(
            "ngTableSelectFilterDs",
            ngTableSelectFilterDs_directive_1.ngTableSelectFilterDs
          )
          .directive(
            "ngTableSorterRow",
            ngTableSorterRow_directive_1.ngTableSorterRow
          )
          .controller(
            "ngTableSorterRowController",
            ngTableSorterRowController_1.NgTableSorterRowController
          );
  ...
  \******************************************/
      /***/ function (module, exports, __webpack_require__) {
        ...
        var NgTableEventsChannel = (function () {
          ...
          NgTableEventsChannel.prototype.addTableParamsEvent = function (
            eventName,
            target
          ) {
            var fnName =
          ...
          NgTableEventsChannel.prototype.createPublishEventFn = function (
            eventName
          ) {
            var _this = this;
            return function () {
              ...
              (_a = _this.$rootScope).$broadcast.apply(
                _a,
                ["ngTable:" + eventName].concat(args)
              );
              var _a;
            };
          };
          NgTableEventsChannel.prototype.createEventSubscriptionFn = function (
            eventName
          ) {
            var _this = this;
        ...
        var NgTableParams = (function () {
          function NgTableParams(baseParameters, baseSettings) {
            ...
            this.defaultSettings =
              NgTableParams.ngTableSettings.createDefaults();
            ...
            this.reloadPages = (function () {
              ...
              return function () {
                ...
                var newPages = _this.generatePagesArray(
                  _this.page(),
                  _this.total(),
                  _this.count()
                );
                if (!ng1.equals(oldPages, newPages)) {
                  ...
                  NgTableParams.ngTableEventsChannel.publishPagesChanged(
                    _this,
                    newPages,
                    oldPages
                  );
           ...
           */
          NgTableParams.prototype.generatePagesArray = function (
            currentPage,
            totalItems,
            pageSize,
            maxBlocks
            ...
            if (numPages > 1) {
              ...
              maxPivotPages = Math.round(
                (this._settings.paginationMaxBlocks -
                  this._settings.paginationMinBlocks) /
                  2
              );
          ...
          NgTableParams.prototype.hasErrorState = function () {
            return !!(
              this.errParamsMemento &&
              ng1.equals(this.errParamsMemento, this.createComparableParams())
            );
          };
          /**
          ...
          NgTableParams.prototype.hasFilterChanges = function () {
            var previousFilter =
              this.prevParamsMemento && this.prevParamsMemento.params.filter;
            return (
              !ng1.equals(this._params.filter, previousFilter) ||
          ...
          NgTableParams.prototype.hasGroup = function (group, sortDirection) {
            if (group == null) {
              return (
                util_1.isGroupingFun(this._params.group) ||
                Object.keys(this._params.group).length > 0
              );
            }
          ...
          NgTableParams.prototype.isSortBy = function (field, direction) {
            if (direction !== undefined) {
              return (
                this._params.sorting[field] !== undefined &&
                this._params.sorting[field] == direction
              );
            } else {
          ...
          NgTableParams.prototype.parameters = function (
            newParameters,
            parseParamsFromUrl
          ) {
            ...
            if (typeof newParameters !== undefined) {
              for (var key in newParameters) {
                ...
                if (parseParamsFromUrl && key.indexOf("[") >= 0) {
                  ...
                  this._params[lastKey] = ng1.extend(
                    this._params[lastKey] || {},
                    value[lastKey]
                  );
                } else {
                  if (key === "group") {
                    ...
                    this._params[key] = isNumber(newParameters[key])
          ...
          NgTableParams.prototype.reload = function () {
            ...
            if (this.hasGroup()) {
              pData = this.runInterceptorPipeline(
                NgTableParams.$q.when(this._settings.getGroups(this))
              );
            } else {
              var fn = this._settings.getData;
              pData = this.runInterceptorPipeline(
                NgTableParams.$q.when(fn(this))
              );
            }
            ...
            return pData
              .then(function (data) {
                ...
                NgTableParams.ngTableEventsChannel.publishAfterReloadData(
                  _this,
                  data,
                  oldData
                );
          ...
          NgTableParams.prototype.settings = function (newSettings) {
            ...
            if (ng1.isDefined(newSettings)) {
              var settings = NgTableParams.ngTableSettings.merge(
                this._settings,
                newSettings
              );
              ...
              var hasDatasetChanged =
                newSettings.hasOwnProperty("dataset") &&
                newSettings.dataset != originalDataset_1;
              if (hasDatasetChanged) {
                ...
                var fireEvent = function () {
                  NgTableParams.ngTableEventsChannel.publishDatasetChanged(
                    _this,
                    newSettings.dataset,
                    originalDataset_1
                  );
          ...
          NgTableParams.prototype.createComparableParams = function () {
            ...
            return {
              params: this._params,
              groupSortDirection: util_1.isGroupingFun(group)
                ? group.sortDirection
                : undefined,
            };
          };
          NgTableParams.prototype.hasGlobalSearchFieldChanges = function () {
            ...
            var previousVal =
              this.prevParamsMemento &&
              this.prevParamsMemento.params.filter &&
              this.prevParamsMemento.params.filter["$"];
          ...
          NgTableParams.prototype.parseGroup = function (group) {
            var defaultSort =
              ...
              this._settings.groupOptions.defaultSort;
            if (!group) {
              return group;
          ...
          NgTableParams.prototype.runInterceptorPipeline = function (
            fetchedData
          ) {
            var _this = this;
        ...
        var NgTableSettings = (function () {
          function NgTableSettings(
            ...
            this.defaults = {
              ...
              getData: function (params) {
                return _this.ngTableDefaultGetData(
          ...
          NgTableSettings.prototype.merge = function (existing, newSettings) {
            ...
            if (newSettings.filterOptions) {
              newSettings.filterOptions = ng1.extend(
                {},
                existing.filterOptions || {},
                newSettings.filterOptions
              );
            }
            if (newSettings.groupOptions) {
              newSettings.groupOptions = ng1.extend(
                {},
                existing.groupOptions || {},
                newSettings.groupOptions
              );
            }
          ...
          NgTableSettings.prototype.optimizeFilterDelay = function (settings) {
            ...
            if (
              settings.filterOptions.filterDelay ===
                this.defaults.filterOptions.filterDelay &&
          ...
          return {
            ...
            compile: function (element) {
              ...
              ng1.forEach(dataRow.find("td"), function (item) {
                ...
                var titleExpr =
                  getAttrValue("title-alt") || getAttrValue("title");
                if (titleExpr) {
                ...
                if (groupRow || el.attr("ng-if")) {
                  ...
                  setAttrValue(
                    "ng-if",
                    "$columns[" + (columns.length - 1) + "].show(this)"
                  );
                }
              });
  ...
  \**************************************/
      /***/ function (module, exports, __webpack_require__) {
        ...
        var NgTableColumn = (function () {
           ...
           */
          NgTableColumn.prototype.buildColumn = function (
            column,
            defaultScope,
            columns
          ) {
              ...
              if (getterFn.assign) {
                ...
                var getterSetter = function getterSetter() {
                  if (arguments.length === 1 && !isScopeLike(arguments[0])) {
                    ...
                    return localValue_1 != undefined
                      ? localValue_1
                      : wrappedGetterFn_1.apply(extendedCol, arguments);
                  }
                };
                getterSetter.assign = function ($scope, value) {
                  localValue_1 = value;
  ...
  \******************************************/
      /***/ function (module, exports, __webpack_require__) {
        ...
        var NgTableController = (function () {
            ...
            "hasVisibleFilterColumn",
            {
              get: function () {
                ...
                return this.some(this.$scope.$columns, function ($column) {
                  return (
                    $column.show(_this.$scope) && !!$column.filter(_this.$scope)
                  );
                });
              },
              enumerable: true,
          ...
          NgTableController.prototype.onDataReloadStatusChange = function (
            newStatus /*, oldStatus*/
          ) {
          ...
          NgTableController.prototype.compileDirectiveTemplates = function () {
            if (!this.$element.hasClass("ng-table")) {
              this.$scope.templates = {
                header: this.$attrs.templateHeader
                  ? this.$attrs.templateHeader
                  : "ng-table/header.html",
                pagination: this.$attrs.templatePagination
                  ? this.$attrs.templatePagination
                  : "ng-table/pager.html",
              };
              ...
              if (!theadFound_1) {
                headerTemplate = ng1.element(
                  '<thead ng-include="templates.header"></thead>',
                  this.$document
                );
          ...
          NgTableController.prototype.loadFilterData = function ($columns) {
            ...
            function isPromiseLike(val) {
              return (
                val && typeof val === "object" && typeof val.then === "function"
              );
            }
          };
          NgTableController.prototype.buildColumns = function (columns) {
            ...
            (columns || []).forEach(function (col) {
              result.push(
                _this.ngTableColumn.buildColumn(col, _this.$scope, result)
              );
            });
            return result;
          };
          NgTableController.prototype.parseNgTableDynamicExpr = function (
            attr
          ) {
          ...
          NgTableController.prototype.setupBindingsToInternalScope = function (
            tableParamsExpr
          ) {
          ...
          NgTableController.prototype.setupFilterRowBindingsToInternalScope =
            function () {
              var _this = this;
              if (this.$attrs.showFilter) {
                ...
                this.$scope.$watch(
                  function () {
                    return _this.hasVisibleFilterColumn;
                  },
                  function (value) {
                    _this.$scope.show_filter = value;
                  }
          ...
          NgTableController.prototype.setupGroupRowBindingsToInternalScope =
            function () {
              var _this = this;
          ...
          NgTableController.prototype.subscribeToTableEvents = function () {
            ...
            this.ngTableEventsChannel.onAfterReloadData(
              ...
              this.$scope,
              function (publisher) {
                return _this.$scope.params === publisher;
              }
            );
            this.ngTableEventsChannel.onPagesChanged(
              function (params, newPages) {
        ...
        function ngTableDynamic() {
          return {
            ...
            compile: function (tElement) {
              ...
              return function (scope, element, attrs, controller) {
                var expr = controller.parseNgTableDynamicExpr(
                  attrs.ngTableDynamic
                );
                controller.setupBindingsToInternalScope(expr.tableParams);
                controller.compileDirectiveTemplates();
                scope.$watchCollection(
                  expr.columns,
                  function (newCols /*, oldCols*/) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var NgTableFilterConfigProvider = (function () {
          function NgTableFilterConfigProvider($injector) {
            ...
            this.$get = function () {
              return $injector.instantiate(NgTableFilterConfig, {
                config: ng1.copy(_this.config),
              });
            };
            this.$get.$inject = [];
            this.resetConfigs();
           ...
           */
          NgTableFilterConfigProvider.prototype.setConfig = function (
            customConfig
          ) {
            var mergeConfig = ng1.extend({}, this.config, customConfig);
            mergeConfig.aliasUrls = ng1.extend(
              {},
              this.config.aliasUrls,
              customConfig.aliasUrls
            );
        ...
        var NgTableFilterConfig = (function () {
           ...
           */
          NgTableFilterConfig.prototype.getUrlForAlias = function (
            aliasName,
            filterKey
          ) {
            return (
              this.config.aliasUrls[aliasName] ||
              this.config.defaultBaseUrl + aliasName + this.config.defaultExt
            );
          };
          /**
           ...
           */
          NgTableFilterConfig.prototype.getTemplateUrl = function (
            filterDef,
            filterKey
          ) {
            var filterName;
      ...
      /***/ function (module, exports) {
        ...
        var NgTableFilterRowController = (function () {
          function NgTableFilterRowController($scope, ngTableFilterConfig) {
            ...
            $scope.getFilterPlaceholderValue =
              this.getFilterPlaceholderValue.bind(this);
          }
          NgTableFilterRowController.prototype.getFilterCellCss = function (
            filter,
            layout
          ) {
          ...
          NgTableFilterRowController.prototype.getFilterPlaceholderValue =
            function (filterDef, filterKey) {
              if (typeof filterDef === "string") {
                return "";
              } else {
      ...
      /***/ function (module, exports) {
        ...
        var NgTableGroupRowController = (function () {
          ...
          NgTableGroupRowController.prototype.getGroupables = function () {
            var _this = this;
            var groupableCols = this.$scope.$columns.filter(function ($column) {
          ...
          NgTableGroupRowController.prototype.getGroupTitle = function (group) {
            return this.isGroupingFunc(group)
              ? group.title
              : group.title(this.$scope);
          };
          NgTableGroupRowController.prototype.getVisibleColumns = function () {
            var _this = this;
            return this.$scope.$columns.filter(function ($column) {
              return $column.show(_this.$scope);
            });
          };
          ...
          NgTableGroupRowController.prototype.isSelectedGroup = function (
            group
          ) {
            if (this.isGroupingFunc(group)) {
          ...
          NgTableGroupRowController.prototype.toggleDetail = function () {
            this.$scope.params.settings().groupOptions.isExpanded =
              !this.$scope.params.settings().groupOptions.isExpanded;
            return this.$scope.params.reload();
          };
          NgTableGroupRowController.prototype.changeSortDirection =
            function () {
              var newDirection;
              if (this.$scope.params.hasGroup(this.$scope.$selGroup, "asc")) {
                newDirection = "desc";
              } else if (
                this.$scope.params.hasGroup(this.$scope.$selGroup, "desc")
              ) {
                newDirection = "";
              } else {
                newDirection = "asc";
          ...
          NgTableGroupRowController.prototype.findGroupColumn = function (
            groupKey
          ) {
            var _this = this;
            return this.$scope.$columns.filter(function ($column) {
              return $column.groupable(_this.$scope) === groupKey;
            })[0];
          };
      ...
      /***/ function (module, exports) {
        ...
        var NgTableSelectFilterDsController = (function () {
          function NgTableSelectFilterDsController($scope, $parse, $attrs, $q) {
            ...
            $scope.$watch(
              function () {
                return _this.$column && _this.$column.data;
              },
              function () {
          ...
          NgTableSelectFilterDsController.prototype.bindDataSource =
            function () {
              var _this = this;
          ...
          NgTableSelectFilterDsController.prototype.hasEmptyOption = function (
            data
          ) {
            var isMatch;
          ...
          NgTableSelectFilterDsController.prototype.getSelectListData =
            function ($column) {
          ...
          NgTableSelectFilterDsController.$inject = [
            "$scope",
            "$parse",
            "$attrs",
            "$q",
        ...
        exports.NgTableSelectFilterDsController =
  ...
  \***************************************************/
      /***/ function (module, exports) {
        ...
        var NgTableSorterRowController = (function () {
          ...
          NgTableSorterRowController.prototype.sortBy = function (
            $column,
            event
          ) {
            ...
            if (!parsedSortable || typeof parsedSortable !== "string") {
              ...
              var sorting =
                this.$scope.params.sorting() &&
                this.$scope.params.sorting()[parsedSortable] &&
                this.$scope.params.sorting()[parsedSortable] === defaultSort;
              var sortingParams =
                event.ctrlKey || event.metaKey
                  ? this.$scope.params.sorting()
                  : {};
              sortingParams[parsedSortable] = sorting
                ? inverseSort
                : defaultSort;
            ...
            function ngTableDefaultGetData($filter, ngTableEventsChannel) {
              ...
              function getFilterFn(params) {
                ...
                if (ng1.isFunction(filterOptions.filterFn)) {
                  ...
                  return $filter(
                    filterOptions.filterFilterName || provider.filterFilterName
                  );
                }
              }
              ...
              function applyFilter(data, params) {
                ...
                return filterFn.call(
                  ...
                  data,
                  parsedFilter,
                  params.settings().filterOptions.filterComparator
                );
              }
              ...
              function getData(data, params) {
                ...
                var options = ng1.extend(
                  {},
                  defaultDataOptions,
                  params.settings().dataOptions
                );
                var fData = options.applyFilter
                  ? applyFilter(data, params)
                  : data;
                ngTableEventsChannel.publishAfterDataFiltered(params, fData);
                var orderedData = options.applySort
                  ? applySort(fData, params)
                  : fData;
                ngTableEventsChannel.publishAfterDataSorted(
                  params,
                  orderedData
                );
                return options.applyPaging
                  ? applyPaging(orderedData, params)
                  : orderedData;
              }
  ...
  \******************/
      /***/ function (module, exports, __webpack_require__) {
        ...
        var ngTableModule = ng1.module("ngTable", [
          core_1.ngTableCoreModule.name,
          browser_1.ngTableBrowserModule.name,
        ]);
